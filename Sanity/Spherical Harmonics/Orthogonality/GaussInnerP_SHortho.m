function [ InnerP ] = GaussInnerP_SHortho( N1,n1,N2,n2,phiarray,thetaarray )
...
for j = 1:length(phiarray)
   ...
   for k = 1:length(thetaarray)
      ...
      InnerP = InnerP +phiarray(2,j)*thetaarray(2,k)* sin(thetaarray(1,k))*EvalSpherHarmPoint(N1,n1,phiarray(1,j),thetaarray(1,k))*conj(EvalSpherHarmPoint(N2,n2,phiarray(1,j),thetaarray(1,k)));
