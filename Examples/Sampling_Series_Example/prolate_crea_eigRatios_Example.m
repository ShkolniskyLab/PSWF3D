function [ratios , ratios_consecutive] = prolate_crea_eigRatios_Example(prolate_dat)
%
...
%
    ...
    dvec = prolate_xdZernikeNorm_coef_Example(prolate_dat.p, prolate_dat.N, prolate_dat.cfs);
