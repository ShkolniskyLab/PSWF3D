function [ CellCoeff ] = SamplingCoeff_AllN_Example( L,fVals,Points,Nmax,Proldat,truncvec,flag )
...
for j = 0:Nmax
   ...
   allcoeffs = SamplingCoeff_N_Example( L,fVals,Points,j,Proldat{1,j+1}, Proldat{2,j+1}, Proldat{3,j+1},truncationparam,flag);
