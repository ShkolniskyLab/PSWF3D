function [ SeriesEval ] = EvalSeries_Example( EvalPoints,SampleSeriesCoeff,truncvec,Proldat,L )
...
for j= 1:Nmax+1
    ...
    [EvalTemp,alphavect] = EvalProlGrid_fixedN_Example(EvalPointsPolar,j-1,Proldat{1,j},Proldat{2,j},Proldat{3,j},truncvec(1,j),1,L);
