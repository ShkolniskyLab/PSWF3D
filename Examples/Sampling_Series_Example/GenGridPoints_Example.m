function [ points,weights ] = GenGridPoints_Example( thetaparam,rparam )
...
phiquad = TrapzAtkinson_Example(phiparam);
thetaquad = QuadRulePolarAtkinson_Example(thetaparam);
rquad = LegndreQuadRecipies_Example( rparam,0,1 );
